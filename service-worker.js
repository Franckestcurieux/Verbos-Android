...
var CACHE_NAME = 'conjugacao-pt-iota47';
...
var ASSETS_TO_CACHE = [
  ...
  './js/data.js?v=iota47',
  './js/core.js?v=iota47',
  './js/engine.js?v=iota47',
  './js/ui-selection.js?v=iota47',
  './js/ui-ref.js?v=iota47',
  './js/voice.js?v=iota47',
  './js/stats.js?v=iota47',
  './js/stats-ui.js?v=iota47',
  './js/tts.js?v=iota47',
  './js/router.js?v=iota47',
  './js/splash.js?v=iota47',
  './js/mode-erreurs.js?v=iota47',
  './js/init.js?v=iota47',
  './js/i18n.js?v=iota47',
  './data/verbs.json',
  './data/meta.json',
