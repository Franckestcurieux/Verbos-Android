...
var CACHE_NAME = 'conjugacao-pt-iota35';
...
var ASSETS_TO_CACHE = [
  ...
  './js/data.js?v=iota35',
  './js/core.js?v=iota35',
  './js/engine.js?v=iota35',
  './js/ui-selection.js?v=iota35',
  './js/ui-ref.js?v=iota35',
  './js/voice.js?v=iota35',
  './js/stats.js?v=iota35',
  './js/stats-ui.js?v=iota35',
  './js/tts.js?v=iota35',
  './js/router.js?v=iota35',
  './js/splash.js?v=iota35',
  './js/mode-erreurs.js?v=iota35',
  './js/init.js?v=iota35',
  './js/i18n.js?v=iota35',
  './data/verbs.json',
  './data/meta.json',
