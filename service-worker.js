...
var CACHE_NAME = 'conjugacao-pt-iota34';
...
var ASSETS_TO_CACHE = [
  ...
  './js/data.js?v=iota34',
  './js/core.js?v=iota34',
  './js/engine.js?v=iota34',
  './js/ui-selection.js?v=iota34',
  './js/ui-ref.js?v=iota34',
  './js/voice.js?v=iota34',
  './js/stats.js?v=iota34',
  './js/stats-ui.js?v=iota34',
  './js/tts.js?v=iota34',
  './js/router.js?v=iota34',
  './js/splash.js?v=iota34',
  './js/mode-erreurs.js?v=iota34',
  './js/init.js?v=iota34',
  './js/i18n.js?v=iota34',
  './data/verbs.json',
  './data/meta.json',
