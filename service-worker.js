...
var CACHE_NAME = 'conjugacao-pt-iota31';
...
var ASSETS_TO_CACHE = [
  ...
  './js/data.js?v=iota31',
  './js/core.js?v=iota31',
  './js/engine.js?v=iota31',
  './js/ui-selection.js?v=iota31',
  './js/ui-ref.js?v=iota31',
  './js/voice.js?v=iota31',
  './js/stats.js?v=iota31',
  './js/stats-ui.js?v=iota31',
  './js/tts.js?v=iota31',
  './js/router.js?v=iota31',
  './js/splash.js?v=iota31',
  './js/mode-erreurs.js?v=iota31',
  './js/init.js?v=iota31',
  './js/i18n.js?v=iota31',
  './data/verbs.json',
  './data/meta.json',
