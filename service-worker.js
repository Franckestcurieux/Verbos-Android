...
var CACHE_NAME = 'conjugacao-pt-iota25';
...
var ASSETS_TO_CACHE = [
  ...
  './js/data.js?v=iota25',
  './js/core.js?v=iota25',
  './js/engine.js?v=iota25',
  './js/ui-selection.js?v=iota25',
  './js/ui-ref.js?v=iota25',
  './js/voice.js?v=iota25',
  './js/stats.js?v=iota25',
  './js/stats-ui.js?v=iota25',
  './js/tts.js?v=iota25',
  './js/router.js?v=iota25',
  './js/splash.js?v=iota25',
  './js/mode-erreurs.js?v=iota25',
  './js/init.js?v=iota25',
  './js/i18n.js?v=iota25',
  './data/verbs.json',
  './data/meta.json',
