...
var CACHE_NAME = 'conjugacao-pt-iota40';
...
var ASSETS_TO_CACHE = [
  ...
  './js/data.js?v=iota40',
  './js/core.js?v=iota40',
  './js/engine.js?v=iota40',
  './js/ui-selection.js?v=iota40',
  './js/ui-ref.js?v=iota40',
  './js/voice.js?v=iota40',
  './js/stats.js?v=iota40',
  './js/stats-ui.js?v=iota40',
  './js/tts.js?v=iota40',
  './js/router.js?v=iota40',
  './js/splash.js?v=iota40',
  './js/mode-erreurs.js?v=iota40',
  './js/init.js?v=iota40',
  './js/i18n.js?v=iota40',
  './data/verbs.json',
  './data/meta.json',
