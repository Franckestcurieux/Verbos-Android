...
var CACHE_NAME = 'conjugacao-pt-iota33';
...
var ASSETS_TO_CACHE = [
  ...
  './js/data.js?v=iota33',
  './js/core.js?v=iota33',
  './js/engine.js?v=iota33',
  './js/ui-selection.js?v=iota33',
  './js/ui-ref.js?v=iota33',
  './js/voice.js?v=iota33',
  './js/stats.js?v=iota33',
  './js/stats-ui.js?v=iota33',
  './js/tts.js?v=iota33',
  './js/router.js?v=iota33',
  './js/splash.js?v=iota33',
  './js/mode-erreurs.js?v=iota33',
  './js/init.js?v=iota33',
  './js/i18n.js?v=iota33',
  './data/verbs.json',
  './data/meta.json',
