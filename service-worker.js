...
var CACHE_NAME = 'conjugacao-pt-iota19';
...
var ASSETS_TO_CACHE = [
  ...
  './js/data.js?v=iota19',
  './js/core.js?v=iota19',
  './js/engine.js?v=iota19',
  './js/ui-selection.js?v=iota19',
  './js/ui-ref.js?v=iota19',
  './js/voice.js?v=iota19',
  './js/stats.js?v=iota19',
  './js/stats-ui.js?v=iota19',
  './js/tts.js?v=iota19',
  './js/router.js?v=iota19',
  './js/splash.js?v=iota19',
  './js/mode-erreurs.js?v=iota19',
  './js/init.js?v=iota19',
  './js/i18n.js?v=iota19',
  './data/verbs.json',
  './data/meta.json',
