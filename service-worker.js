...
var CACHE_NAME = 'conjugacao-pt-iota29';
...
var ASSETS_TO_CACHE = [
  ...
  './js/data.js?v=iota29',
  './js/core.js?v=iota29',
  './js/engine.js?v=iota29',
  './js/ui-selection.js?v=iota29',
  './js/ui-ref.js?v=iota29',
  './js/voice.js?v=iota29',
  './js/stats.js?v=iota29',
  './js/stats-ui.js?v=iota29',
  './js/tts.js?v=iota29',
  './js/router.js?v=iota29',
  './js/splash.js?v=iota29',
  './js/mode-erreurs.js?v=iota29',
  './js/init.js?v=iota29',
  './js/i18n.js?v=iota29',
  './data/verbs.json',
  './data/meta.json',
